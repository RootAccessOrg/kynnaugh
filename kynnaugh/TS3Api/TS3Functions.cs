...
{
    // from https://github.com/dimentox/c_sharp_teamspeak_plugin/blob/master/TS/tscrap.cs

    // most of these SHOULD NOT BE USED - they are imported as placeholders
    // all string/LPStr MUST be replaced with proper UTF8 handling before use
